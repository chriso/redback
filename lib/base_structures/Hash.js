...
/**
 * Sets a key/value pair but only if the key doesn't already exist.
 *
 * @param {string} hash_key
 * @param {string} value
 * @param {Function} callback
...
Hash.prototype.increment = Hash.prototype.incrBy = function (hash_key, amount, callback) {
...
Hash.prototype.decrement = Hash.prototype.decrBy = function (hash_key, amount, callback) {
    if (typeof amount === 'function') {
        callback = amount;
        amount = 1;
    }
