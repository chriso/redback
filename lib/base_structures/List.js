 ...
 *
 * @param {int} index
 * @param {count} count (optional - defaults to 1)
 * @param {Function} callback
 * @return this
 * @api public
 */
...
List.prototype.shift = function (wait, callback) {
    if (typeof wait === 'function') {
        ...
        this.client.blpop(this.key, callback);
    }
    return this;
}
...
List.prototype.pop = function (wait, callback) {
    if (typeof wait === 'function') {
        ...
        this.client.brpop(this.key, callback);
    }
    return this;
}
...
List.prototype.popShift = function (list, wait, callback) {
    ...
    if (typeof wait === 'function') {
        ...
        this.client.brpoplpush(this.key, list, callback);
    }
    return this;
}
