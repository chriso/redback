...
Set.prototype.inter = function (/* set(s), */ callback) {
    var sets = this.getKeys(arguments);
...
Set.prototype.interStore = function (dest, /* set(s), */ callback) {
    var sets = this.getKeys(arguments),
        dest = sets.shift();
...
Set.prototype.union = function (/* set(s), */ callback) {
    var sets = this.getKeys(arguments);
    sets.unshift(this.key);
...
Set.prototype.unionStore = function (dest, /* set(s), */ callback) {
    var sets = this.getKeys(arguments),
        dest = sets.shift();
    sets.unshift(dest, this.key);
...
Set.prototype.diff = function (/* set(s), */ callback) {
    var sets = this.getKeys(arguments);
    sets.unshift(this.key);
...
Set.prototype.diffStore = function (dest, /* set(s), */ callback) {
    var sets = this.getKeys(arguments),
        dest = sets.shift();
    sets.unshift(dest, this.key);
