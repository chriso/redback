...
/**
 * A wrapper for the Redis sorted set (zset) type. Each element has an
...
SortedSet.prototype.exists = SortedSet.prototype.contains = function (element, callback) {
 ...
 * to the highest.
 *
 * Note: start and end have been deliberately switched for consistency.
